...
/**
 * @brief Represents an iterator for a strizzle String.
 */
typedef struct {
    String *string;
    int index;
...
/**
 * @brief Creates a new strizzle string instance from a null-terminated C string.
 * 
...
/**
 * @brief Creates a new empty strizzle string.
 * 
 * The returned string must be freed with string_free().
 */
String string_empty();
...
/**
 * @brief Creates a new strizzle string by copying another String instance.
 * 
 * The returned string must be freed with string_free().
 */
...
/**
 * @brief Frees a strizzle string instance.
 */
...
/**
 * @brief Creates a new strizzle string filled with 'c', 'n' times
 * 
 * The returned string must be freed with string_free().
 */
 ...
 */
String string_concat_char(String s, char c);
 ...
 */
int string_starts_with_char(char c, String s);
